...
public:
    ...
    static void frame_linux_dmabuf(void *data, zwlr_screencopy_frame_v1 *frame, uint32_t format, uint32_t width, uint32_t height, uint32_t stride, uint32_t modifier_hi, uint32_t modifier_lo);
